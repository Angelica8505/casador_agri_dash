...
const Sidebar = () => {
  const menuItems = [
    ...
    { name: 'Crops', icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z' },
    { name: 'Weather', icon: 'M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z' },
  ...
  return (
    <aside className="bg-gray-800 text-white w-64 min-h-screen">
      <div className="p-6">
        <h2 className="text-2xl font-semibold">AgriDash</h2>
      </div>
      <nav className="mt-6">
        {menuItems.map((item, index) => (
          <Link
            key={index}
            to={item.name === 'Dashboard' ? '/' : `/${item.name.toLowerCase()}`}
